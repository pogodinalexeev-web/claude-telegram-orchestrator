...
> **Дефолтный формат финала — .jpeg.** После генерации HTML+SVG конвертировать в JPEG командой:
> `.claude/scripts/html-to-jpg.sh <input.html>` — headless Chrome screenshot → sips JPEG качество 85. Отдавать owner'у .jpg, исходный .html сохранять рядом. Исключение — owner явно сказал «оставь как HTML/SVG».
